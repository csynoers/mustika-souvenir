<?php
$page = $database->select($fields="*", $table="modul", $where_clause="WHERE id_modul={$_GET['id']}", $fetch="");
...
<main role="main" class="flex-shrink-0">
  <div class="container content-news">
    ...
    <ol class="breadcrumb bg-transparent p-0 mt-3">
      <li class="breadcrumb-item"><a href="<?php echo $config['web_index']?>">Page</a></li>
      <li class="breadcrumb-item active text-nowrap" aria-current="page"><?= $page['nama_modul'] ?></li>
    </ol>
  
    <div class="row">
      <div class="col-md-12 col-lg-8 page-result right-list">
        <h5><?php echo $page["nama_modul"];?></h5>
