<link rel="stylesheet" href="bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <section class="content">
    <ol class="breadcrumb mb-0 name_services">
      ...
      <li class="active">Cari Properti</a></li>
    </ol>
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body table-responsive">
            <table id="search_data" class="table table-bordered table-striped" style="width: 100%">
              <thead>
                <tr>
                  <th width="2%">No</th>
                  <th width="15%">Fullname</th>
                  <th width="20%">Properti Search</th>
    ...
    <form method="post" id="form_input" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New search</h4>
        </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="information">Jenis Properti </label>
                    <input type="text" class="form-control" name="information" id="information" placeholder="Enter information" readonly="">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="city">Area (kota/kabupaten) </label>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea name="facilities" id="facilities" class="form-control" placeholder="Enter facilities" readonly="" rows="5"></textarea>
                  </div>
                </div>
...
<script src="modul/search/search.js?v=1.0.0"></script>