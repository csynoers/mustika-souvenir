      ...
      <div class="col-xs-12">
        <div class="box">
         <!--  <div class="box-header">
            <button type="button" id="add_button" data-toggle="modal" data-target="#contactModal" class="btn btn-primary btn-sm btn-flat pull-right"><i class="fa fa-plus"></i> Add New contact</button>
          </div> -->

          <div class="box-body table-responsive">
            <table id="contact_data" class="table table-bordered table-striped" style="width: 100%">
              <thead>
                <tr>
                  <th width="2%">No</th>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12">
              <label>Status</label>
              <div class="form-group">
                <input type="radio" value="1" id="statusTrue" name="status" checked="" disabled=""> <span>Publish</span>
                <input type="radio" value="0" id="statusFalse" name="status" disabled="" > <span>Hidden</span>
              </div>
            </div>
            <!-- <div class="col-sm-12">
              <div class="row">
...
<script src="modul/contact/contact.js?v=1"></script>